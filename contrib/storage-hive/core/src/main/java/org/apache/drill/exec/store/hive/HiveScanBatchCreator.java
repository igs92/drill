...
import org.apache.drill.exec.store.hive.readers.initilializers.ExperimentalReadersInitializer;
...
public class HiveScanBatchCreator implements BatchCreator<HiveSubScan> {
  ...
  public ScanBatch getBatch(ExecutorFragmentContext context, HiveSubScan config, List<RecordBatch> children)
    ...
    return new ScanBatch(config, context, ExperimentalReadersInitializer.init(context, config));
  }
}
