 ...
 * (for example, elements of List complex type). With help of such abstraction we can build
 * writers for complex types which also rely on writers for row's embedded elements.
 * <p>
...
public interface HiveValueWriter {
  ...
  default void writeNull() {
    // todo: make abstract and implement for all writers, it's required for writing nulls as list elements
  }
