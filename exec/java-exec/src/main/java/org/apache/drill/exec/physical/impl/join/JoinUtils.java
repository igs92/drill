...
public class JoinUtils {
  ...
  public static final String FAILED_TO_PLAN_CARTESIAN_JOIN = String.format(
      "This query cannot be planned possibly due to either a cartesian join or an inequality join. " +
          "If cartesian or inequality join is used intentionally, set option '%s' to false and try again.",
   ...
   * which accepts relNode and passes empty lists for other parameters
   *
