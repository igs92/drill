...
public class DrillIntersectRel extends Intersect implements DrillRel {
  ...
  public LogicalOperator implement(DrillImplementor implementor) {
    // todo: implement
    throw new UnsupportedOperationException("DrillIntersectRel.implement() is not supported");
  }
